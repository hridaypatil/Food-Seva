...
if (strlen($_SESSION['pgasaid'] == 0)) {
  ...
  <head>
    <title>Food Seva|| Food Requests</title>
                  ...
                  <table border="1" class="table table-bordered mg-b-0">
                    <tr align="center">
                      <td colspan="4" style="font-size:20px;color:blue">
                        View Request Details of #
                        <?php echo $row['requestNumber']; ?>
                      </td>
                    </tr>
                    <tr>
                      <th>Register By </th>
                    ...
                    <?php if ($row['donorRemark'] != ''): ?>
                      <tr>
                        <th>Donar Remark</th>
                        <td>
                          <?php echo $row['donorRemark']; ?>
                        </td>
                        <th>Remark Date</th>
                        <td>
                          <?php echo $row['requestCompletionDate']; ?>
                        </td>
                      </tr>
                    <?php endif; ?>
